        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white p-6 rounded-[var(--radius-lg)] elevation-1 border border-[var(--color-outline-variant)]">
            ...
            <div className="space-y-3">
              ...
              <button onClick={() => window.location.href = `mailto:?subject=Proforma ${quotation.quotation_number}&body=Segue o link para aceder à proforma: ${window.location.origin}/dashboard/pdf-preview/${quotation.id}`} className="w-full flex items-center justify-center gap-2 py-2.5 bg-gray-50 text-gray-700 hover:bg-gray-100 border border-gray-200 rounded-lg transition-colors font-medium text-sm">
                <Send className="w-4 h-4" /> Enviar por Email
              </button>
              <button onClick={() => window.open(`https://wa.me/?text=Olá, pode consultar a proforma ${quotation.quotation_number} neste link: ${window.location.origin}/dashboard/pdf-preview/${quotation.id}`, '_blank')} className="w-full flex items-center justify-center gap-2 py-2.5 bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366]/20 border border-[#25D366]/30 rounded-lg transition-colors font-medium text-sm">
